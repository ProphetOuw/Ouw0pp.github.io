...
## Reminders
 ...
 - Add repetitive vfx functions into the vfxutility if not there already and use them from the module. This module **SHOULD ONLY BE EDITED IN DX MAIN PLACE THEN PUBLISHED**.
